...
/*
There are 3 ways to customize conf in modules that use idanode-common lib:
...
if (exports.storage === 'mysql'){
	...
	exports.database.name = exports.database.name || 'idanode';
	exports.database.user = exports.database.user || 'idanode';
}
else if (exports.storage === 'sqlite'){
	exports.database.max_connections = exports.database.max_connections || 1;
	exports.database.filename = exports.database.filename || (exports.bLight ? 'idanode-light.sqlite' : 'idanode.sqlite');
}
